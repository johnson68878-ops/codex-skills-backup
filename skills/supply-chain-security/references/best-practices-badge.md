---
description: OpenSSF Best Practices Badge Passing, Silver, and Gold tier criteria
---
...
OpenSSF Best Practices Badge criteria derived from the CII Best Practices Badge project, licensed under MIT (criteria) and CC BY 3.0+ (documentation). Source: <https://www.bestpractices.dev/>
